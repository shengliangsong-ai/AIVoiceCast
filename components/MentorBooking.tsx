...
import { Calendar, Clock, User, ArrowLeft, Search, Briefcase, Sparkles, CheckCircle, X, Loader2, Play, Users, Mail, Video, Mic, FileText, Download, Trash2, Monitor, UserPlus, Grid, List, ArrowDown, ArrowUp, Heart, Share2, Info, ShieldAlert, ChevronRight, Coins, Check as CheckIcon, HeartHandshake, Edit3, Timer, Coffee, Sunrise, Sun, Sunset, Hash, Star, ShieldCheck, MoreHorizontal } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 animate-fade-in space-y-10 flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-h-0 space-y-6">
                <div className="bg-slate-900 border border-slate-800 p-8 rounded-[2.5rem] shadow-xl flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group shrink-0">
                    ...
                    <div className="flex-1 text-center md:text-left relative z-10">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed max-w-2xl">Connect with experts, join live coding sessions, and earn VoiceCoins by sharing your unique expertise.</p>
                        {userProfile && (
                ...
                {/* TABLE FORMAT FOR COMMUNITY MENTORS */}
                <div className="flex-1 bg-slate-900 border border-slate-800 rounded-[2rem] overflow-hidden shadow-2xl flex flex-col min-h-0">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-slate-950/50 sticky top-0 z-20 backdrop-blur-md border-b border-slate-800">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-[10px] font-black uppercase text-slate-500 tracking-widest">Role & Expertise</th>
                                ...
                                {loadingMembers ? (
                                    <tr>
                                        <td colSpan={5} className="py-20 text-center">
                                            ...
                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mt-4">Paging Intelligence Directory...</p>
                                        </td>
                                    </tr>
                                ) : filteredMembers.length === 0 ? (
                                    <tr>
                                        <td colSpan={5} className="py-20 text-center text-slate-500 italic">No matching experts found.</td>
                                    </tr>
                                    ...
                                    <tr key={m.uid} className="group hover:bg-slate-800/30 transition-colors">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center gap-3">
                                                <div className="relative">
                                                    {m.photoURL ? <img src={m.photoURL} className="w-10 h-10 rounded-xl object-cover border-2 border-slate-800 shadow-lg" /> : <div className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-slate-600 border-2 border-slate-800"><User size={20}/></div>}
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2 text-amber-500">
                                                ...
                                                <span className="text-[9px] text-slate-600 font-bold uppercase">/ session</span>
                                            </div>
                                        </td>
                    ...
                    <div className="p-4 bg-slate-950 border-t border-slate-800 flex items-center justify-between shrink-0">
                        <p className="text-[9px] text-slate-600 font-black uppercase tracking-widest">{filteredMembers.length} Experts Online</p>
                        <div className="flex items-center gap-4 text-[9px] font-bold text-slate-600 uppercase">
                            <span className="flex items-center gap-1"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500"></div> Available</span>
                            <span className="flex items-center gap-1"><div className="w-1.5 h-1.5 rounded-full bg-slate-700"></div> Away</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {activeTab === 'ai_mentors' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 overflow-y-auto pr-2 scrollbar-thin">
                        ...
                        <div key={b.id} className="bg-slate-900 border border-slate-800 p-6 rounded-[2rem] flex flex-col md:flex-row items-center gap-6 group hover:border-indigo-500/30 transition-all shadow-xl animate-fade-in-up">
                            ...
                            <div className="flex gap-2">
                                {b.status === 'scheduled' ? (
                                    ...
                                    <div className="text-xs text-slate-500 font-bold italic px-4 bg-slate-800/50 py-2 rounded-lg">Pending Acceptance...</div>
                                )}
