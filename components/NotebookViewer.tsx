              ...
              {loading ? (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-2 mt-2">
                          <span className="text-[9px] px-1.5 py-0.5 bg-slate-950 rounded text-slate-400 font-mono border border-slate-800">v4.3.0</span>
                  ...
                  <div className="flex-1 overflow-y-auto p-8 lg:px-24 scrollbar-thin scrollbar-thumb-slate-800">
                      <div className="max-w-4xl mx-auto w-full pb-32">
                          ...
                          <div className="mb-12 space-y-4">
                              <span className="text-[10px] font-black text-indigo-500 uppercase tracking-[0.3em]">Scientific Notebook v4.3.0</span>
